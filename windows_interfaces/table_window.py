...
class Ui_TableForm(object):
    def setupUi(self, TableForm):
        ...
        self.xlsx_button.setGeometry(QtCore.QRect(280, 520, 111, 31))
        self.xlsx_button.setObjectName("xlsx_button")
        self.csv_button = QtWidgets.QPushButton(TableForm)
        self.csv_button.setGeometry(QtCore.QRect(280, 570, 111, 31))
    ...
    def retranslateUi(self, TableForm):
        ...
        self.xlsx_button.setText(_translate("TableForm", "Импорт в xlsx"))
        self.csv_button.setText(_translate("TableForm", "Имопрт в csv"))
